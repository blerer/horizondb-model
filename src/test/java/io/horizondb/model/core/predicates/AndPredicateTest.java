...
public class AndPredicateTest {
    ...
    public void testGetTimestampRangesWithGTAndLT() {
        ...
        Predicate left = Predicates.gt("timestamp", timeInMillis + "ms"); 
        Predicate rigth = Predicates.lt("timestamp", (timeInMillis + 100) + "ms"); 
    ...
    public void testGetTimestampRangesWithGTAndLTAndResultingEmptyRange() {
        ...
        Predicate left = Predicates.lt("timestamp", timeInMillis + "ms"); 
        Predicate rigth = Predicates.gt("timestamp", (timeInMillis + 100) + "ms"); 
    ...
    public void testGetTimestampRangesWithNotInAndBetween() {
        ...
        Predicate left = Predicates.notIn("timestamp", Arrays.asList((timeInMillis - 10) + "ms",
                                                                       timeInMillis + "ms",
                                                                       (timeInMillis + 10) + "ms")); 
