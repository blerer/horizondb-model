...
public class ProjectionTest {
    ...
    private TimeSeriesDefinition timeSeriesDefinition;
    ...
    public void setUp() {
        ...
        this.timeSeriesDefinition = TimeSeriesDefinition.newBuilder("test")
    ...
    public void testWithAll() {
        ...
        Projection projection = new Projection(Arrays.asList("*"));
        
        RecordSetDefinition def = projection.getDefinition(this.timeSeriesDefinition);
        
        Iterator<RecordTypeDefinition> iterator = def.iterator();
    }
