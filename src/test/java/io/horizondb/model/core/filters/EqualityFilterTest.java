...
import io.horizondb.model.core.filters.EqualityFilter;
...
public class EqualityFilterTest {
    ...
    public void testAccept() throws IOException {
        ...
        Filter<Integer> filter = new EqualityFilter<Integer>(3);
    ...
    public void testAcceptWithValueNeverDecreasing() throws IOException {
        ...
        Filter<Integer> filter = new EqualityFilter<Integer>(3, true);
        assertFalse(filter.isDone());
        assertFalse(filter.accept(1));
        assertFalse(filter.isDone());
        assertFalse(filter.accept(2));        
