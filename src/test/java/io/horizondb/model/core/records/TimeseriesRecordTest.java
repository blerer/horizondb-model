...
public class TimeseriesRecordTest {
    ...
    public void testSubstractWithDecimalFieldAndNoExponentChange() throws IOException {
        ...
        TimeSeriesRecord first = new TimeSeriesRecord(TYPE, TimeUnit.MILLISECONDS, FieldType.DECIMAL, FieldType.LONG);
        first.setTimestampInMillis(0, 100);
        first.setDecimal(1, 104, -1);
        first.setLong(2, 3);

        TimeSeriesRecord second = new TimeSeriesRecord(TYPE, TimeUnit.MILLISECONDS, FieldType.DECIMAL, FieldType.LONG);
        ...
        TimeSeriesRecord expected = new TimeSeriesRecord(TYPE, TimeUnit.MILLISECONDS, FieldType.DECIMAL, FieldType.LONG);
    ...
    public void testWriteToWithDecimalField() throws IOException {
        ...
        TimeSeriesRecord record = new TimeSeriesRecord(TYPE, TimeUnit.NANOSECONDS, FieldType.DECIMAL);
        ...
        assertArrayEquals(new byte[] { 6, -48, -23, -60, 9, 24, 1 }, buffer.array());
    }
    ...
    public void testComputeSize() throws IOException {
        ...
        TimeSeriesRecord record = new TimeSeriesRecord(0,
