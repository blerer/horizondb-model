 ...
 */
@Immutable
public final class CreateTimeSeriesPayload implements Payload {
    
    /**
     * The parser instance.
     */
    private static final Parser<CreateTimeSeriesPayload> PARSER = new Parser<CreateTimeSeriesPayload>() {

        /**
         * {@inheritDoc}
         */
        @Override
        public CreateTimeSeriesPayload parseFrom(ByteReader reader) throws IOException {

            String databaseName = VarInts.readString(reader);    
            TimeSeriesDefinition definition = TimeSeriesDefinition.parseFrom(reader);
            
            return new CreateTimeSeriesPayload(databaseName, definition);
        }
    };
     ...
     */
    public CreateTimeSeriesPayload(String databaseName, TimeSeriesDefinition definition) {
     ...
     */
    public static CreateTimeSeriesPayload parseFrom(ByteReader reader) throws IOException {
     ...
     */
    public static Parser<CreateTimeSeriesPayload> getParser() {
